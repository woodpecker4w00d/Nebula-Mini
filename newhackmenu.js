javascript:(function(){
    ...
    let buttonList = [
        ...
        { label: 'Interstellar', action: () => { let s = document.createElement('script'); s.src = 'https://woodpecker4w00d.github.io/Nebula-Mini/interstellaropen.js'; s.onload = function() { console.log('Hack Menu loaded!'); }; document.body.appendChild(s); } }
    ];
